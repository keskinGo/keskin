...
# content_format.set_bottom()
# content_format.set_left()
# content_format.set_right()
content_len = len(group_id)

worksheet.conditional_format(first_row=2, first_col=0, last_row=content_len+2, last_col=9,
